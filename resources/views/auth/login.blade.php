                            ...
                            <div class="row g-0">
                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <div class="mb-4">
                                                <a href="index.html" class="d-block">
                                                    <img style="object-fit: cover" src="{{url_plug()}}/img/logo.png" alt="" width="100%">
                                                </a>
                                            </div>
                                            <div class="mt-auto">
                                                <div class="mb-3">
                                                ...
                                                <div id="qoutescarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                                    ...
                                                    <div class="carousel-inner text-center text-white-50 pb-5">
                                                        <div class="carousel-item active">
                                                            <p class="fs-15 fst-italic">" Berani Benar Keren! "</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">" Aplikasi Audit Management System (AMS) Dinas Inspektorat Cilegon."</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">" Jalan Jenderal Sudirman No.2, Kecamatan Purwakarta, Ramanuju, Kec. Cilegon, Kota Cilegon, Banten 42431. "</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- end carousel -->
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            <h5 class="text-primary">Audit Management System (AMS) !</h5>
                                            <p class="text-muted">Sign in to continue to AMS.</p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <form method="POST" action="{{ route('login') }}">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="email"  class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Enter username" required>
                                                </div>
                                                @error('email')
                                                    {{ $message }} </span>
                                                @enderror
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0">&copy;
                                <script>document.write(new Date().getFullYear())</script> Ams. Audit Management System <i class="mdi mdi-heart text-danger"></i> by Dinas Inspektorat Cilegon
                            </p>
                        </div>
                    </div>
                </div>
