...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="row pb-3">
                        <div class="col-sm-12 col-md-6">
                            ...
                            <button onclick="created(0)" class="btn btn-sm btn-success waves-effect waves-light "><i
                                    class="mdi mdi-plus-circle-outline"></i> Tambah</button>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="data-table-fixed-header"
                                            class="table table-bordered table-responsive dt-responsive nowrap table-striped align-middle dataTable no-footer dtr-inline collapsed"
                                            style="width: 100%;">
                                            <thead>
                                                <tr>
            ...
            <div class="modal fade" id="modalAdd" role="dialog" aria-labelledby="exampleModalLabelDefault"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{ url('perencanaan/pkpt/store') }}" id="data-user" method="post"
...
@section('script')
    ...
    <script src="{{ url_plug() }}/assets/libs/filepond-plugin-image-preview/filepond-plugin-image-preview.min.js">
    </script>
    <script
        src="{{ url_plug() }}/assets/libs/filepond-plugin-file-validate-size/filepond-plugin-file-validate-size.min.js">
    </script>
    <script
        src="{{ url_plug() }}/assets/libs/filepond-plugin-image-exif-orientation/filepond-plugin-image-exif-orientation.min.js">
    </script>
...
@push('ajax')
    ...
    <script>
        function created(id) {
            location.assign("{{ url('perencanaan/non-pkpt/create?id_pkpt=') }}" + id);
        }
