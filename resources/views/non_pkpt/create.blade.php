                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="area_pengawasan" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select name="" class="form-control" id="">
                                                ...
                                                @foreach ($jenis_pengawasan as $jp)
                                                    <option value="{{ $jp->id_pkpt }}"> {{ $jp->jenis }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="" class="form-control" id="">
                                                ...
                                                @foreach ($bulan as $bln)
                                                    <option value="{{ $bln->no }}"> {{ $bln->bulan }} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="jumlah_laporan" class="form-control"
                                                id="product-title-input" value="" placeholder="Enter product title"
                                                required="">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label class="form-label" for="product-title-input">Sarana dan
                                                    prasarana</label>
                                                <input type="text" name="jumlah_laporan" class="form-control"
                                                    id="product-title-input" value=""
                                                    placeholder="Enter product title" required="">
